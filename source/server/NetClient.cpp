...
NetClient::NetClient(const std::string& label, const StoragePtr p_storage)
    : m_netClientName { label }
    , m_pStorage { p_storage }
{
}
...
void NetClient::incomingConnection(IConnection& connection, Response& req)
{
    // TODO: create incoming connection
}

// TODO: fix this publish function
void NetClient::publish(std::string element)
{
    QueuedClient::pushBack(element);
}
